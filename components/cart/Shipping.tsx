...
import { CartContextProps, userAddress } from "@/interfaces";
...
const Shipping = ({ addresses }: { addresses: userAddress[] }) => {
	...
	const [shippingInfo, setShippingInfo] = useState<string | number>("");

	const setShippingAddress = (address: userAddress) => {
					...
					<div className="flex flex-col md:flex-row gap-4 lg:gap-8">
						<main className="md:w-2/3">
							<article className="border border-gray-200 bg-white shadow-sm rounded p-4 lg:p-6 mb-5">
								...
								>
									<i className="mr-1 fa fa-plus"></i> Add new
									address
								</Link>
